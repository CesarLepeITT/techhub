...
import { ArrowRight, GraduationCap, Package, Puzzle, RefreshCw, Send, Sparkles, Zap } from "lucide-react"
...
export default function AssistantPage() {
  ...
  const handleSubmit = async (prompt: string) => {
    ...
    setMessages((prev) => [
      ...prev,
      { id: Date.now().toString(), type: "user", content: prompt, timestamp: new Date() },
    ])
    setInputValue("")
    setIsTyping(true)
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          ...
          type: "assistant",
          content:
            "No pude procesar tu solicitud ahora mismo. Cuéntame tu presupuesto, categoría y tipo de proyecto para ayudarte mejor.",
          timestamp: new Date(),
        },
      ])
    } finally {
